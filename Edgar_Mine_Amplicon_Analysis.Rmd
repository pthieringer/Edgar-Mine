...
fastaRef <- "~/Documents/Microbes/Edgar Mine/Analysis of Summer 2019/silva_nr_v132_train_set.fa"
...
```{r}
samdf <- read.csv("~/Documents/Microbes/Edgar Mine/Analysis of Summer 2019/Edgar_Summer2019_Metadata.csv",header=TRUE)
